...
import {
  ...
  BranchPagination, BranchProduct, StoreType, AssetSize, Supplier, Division, DataUser, DataBank
} from './page.types';
...
*/
  ...
  new(data: any): Observable<any> {
    ...
    //     return throwError('User is already logged in.');
    // }
    return this._httpClient.post(environment.API_URL + 'api/microsoft', data, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
  ...
  getById(Id: string): Observable<DataBank> {
    return this._httpClient.get<DataBank>(environment.API_URL + 'api/microsoft/' + Id)
  }

  //   * update branch
  update(data: any): Observable<any> {
    return this._httpClient.post(environment.API_URL + 'api/update_microsoft', data, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
  ...
  getPage(dataTablesParameters: any): Observable<DataTablesResponse> {
    return this._httpClient.post(environment.API_URL + 'api/microsoft_page', dataTablesParameters, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
        return of(response.data);
      })
    );
  ...
  getAll(): Observable<any> {
    return this._httpClient.get<any>(environment.API_URL + 'api/get_microsoft')
  }
  ...
  newTransaction(data: FormData): Observable<DataUser> {
    return this._httpClient.post<DataUser>(environment.API_URL + 'api/bank_trans', data, { headers: this.httpOptionsFormdata.headers });
  }
