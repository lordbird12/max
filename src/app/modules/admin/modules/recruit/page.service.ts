...
export class Service {
    ...
    ///create branch////
    meeting(data: any): Observable<any> {
        return this._httpClient
            .post(
                environment.API_URL + 'api/meetings',
                data,
                this.httpOptionsFormdata
            )
            .pipe(
    ...
    create(data: any): Observable<any> {
        return this._httpClient
            .post(
                environment.API_URL + 'api/recruitment',
                data,
                this.httpOptionsFormdata
            )
            .pipe(
    ...
    getById(Id: string): Observable<any> {
        return this._httpClient.get<any>(
            environment.API_URL + 'api/recruitment/' + Id
        );
    }

    getUserJobById(Id: string): Observable<any> {
        return this._httpClient.get<any>(
            environment.API_URL + 'api/user_job/' + Id
        );
    }

    //   * get branch by id
    getJobById(Id: string): Observable<DataBank> {
    ...
    getPage(dataTablesParameters: any): Observable<DataTablesResponse> {
        return this._httpClient
            .post(
                environment.API_URL + 'api/recruitment_page',
                dataTablesParameters,
                this.httpOptionsFormdata
            )
            .pipe(
