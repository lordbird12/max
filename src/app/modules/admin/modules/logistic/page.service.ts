...
export class Service {
    ...
    new(data: any): Observable<any> {
        return this._httpClient
            .post(
                environment.API_URL + 'api/logistic',
                data,
                this.httpOptionsFormdata
            )
            .pipe(
    ...
    //   * get branch by id
    getById(bankId: string): Observable<DataBank> {
        return this._httpClient.get<DataBank>(
            environment.API_URL + 'api/logistic/' + bankId
        );
    }
    ...
    update(data: any): Observable<any> {
        return this._httpClient
            .post(
                environment.API_URL + 'api/update_logistic',
                data,
                this.httpOptionsFormdata
            )
            .pipe(
    ...
    getPage(dataTablesParameters: any): Observable<DataTablesResponse> {
        return this._httpClient
            .post(
                environment.API_URL + 'api/logistic_page',
                dataTablesParameters,
                this.httpOptionsFormdata
            )
            .pipe(
    ...
    getAll(): Observable<any> {
        return this._httpClient.get<any>(
            environment.API_URL + 'api/get_logistic'
        );
    }
