...
export class EditPopupComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        this.formData = this._formBuilder.group({
            ...
            model_category_id: [
                this._data.item.model_category_id,
                Validators.required,
            ],
            name: [this._data.item.name, Validators.required],
            color_id: [parseInt(this._data.item.color_id), Validators.required],
            maxe_id: [parseInt(this._data.item.maxe_id), Validators.required],
            image: '',
        });
    ...
    getMax(): void {
        this._Service.getMax().subscribe((resp) => {
            ...
            this.formData.patchValue({
                ...
                color_id: parseInt(this._data.item.color_id),
                maxe_id: parseInt(this._data.item.maxe_id),
            });
