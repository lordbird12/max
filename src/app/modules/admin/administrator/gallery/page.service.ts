...
export class Service {
    ...
    create(data: any): Observable<any> {
        return this._httpClient
            .post(
                environment.API_URL + '/api/galleries',
                data,
                this.httpOptionsFormdata
            )
            .pipe(
    ...
    getList(id): Observable<any> {
        return this._httpClient
            .get<any>(environment.API_URL + '/api/get_galleries/'+id)
            .pipe(
                tap((meterial) => {
                    this._materials.next(meterial);
                })
    ...
    getCategory(): Observable<any> {
        return this._httpClient
            .get<any>(environment.API_URL + '/api/get_galleries_category')
            .pipe(
                tap((data) => {
    ...
    delete(id: any): Observable<any> {
        return this._httpClient.delete<any>(
            environment.API_URL + '/api/galleries/' + id,
            { headers: this.httpOptionsFormdata.headers }
        );
    }

    //* get position by id
    getById(positionId: any): Observable<any[]> {
        return this._httpClient
            .get<any[]>(environment.API_URL + '/api/round/' + positionId)
            .pipe(
                tap((meterial) => {
                    this._materials.next(meterial);
                })
    ...
    update(data: any, id): Observable<any> {
        return this._httpClient
            .put(
                environment.API_URL + '/api/round/' + id,
                data,
                this.httpOptionsFormdata
            )
            .pipe(
