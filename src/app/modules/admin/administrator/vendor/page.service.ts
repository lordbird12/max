...
export class Service {
    ...
    private _products: BehaviorSubject<BranchProduct[] | null> =
        new BehaviorSubject(null);
    private _product_osm: BehaviorSubject<BranchProduct | null> =
        new BehaviorSubject(null);
    private _products_osm: BehaviorSubject<BranchProduct[] | null> =
        new BehaviorSubject(null);
    ...
    getProducts(
        ...
        return this._httpClient
            .get<{ meta: BranchPagination; data: BranchProduct[] }>(
    ...
    createProduct(): Observable<BranchProduct> {
        return this.products$.pipe(
            ...
            switchMap((products) =>
                this._httpClient
                    .post<BranchProduct>('api/marketing/brief-plan/product', {})
                    .pipe(
                        map((newProduct) => {
    ...
    ): Observable<BranchProduct> {
        return this.products$.pipe(
            take(1),
            switchMap((products) =>
                this._httpClient
                    .patch<BranchProduct>('api/marketing/brief-plan/product', {
                        id,
                        product,
                    })
                    .pipe(
    ...
    getMaterial(): Observable<any[]> {
        return this._httpClient
            .get<any[]>(environment.API_URL + 'api/get_asset_material')
            .pipe(
                tap((meterial) => {
    ...
    new(data: any): Observable<any> {
        ...
        return this._httpClient
            .post(
                environment.API_URL + 'api/vendor',
                data,
                this.httpOptionsFormdata
            )
            .pipe(
    ...
    update(data: any): Observable<any> {
        ...
        return this._httpClient
            .post(
                environment.API_URL + 'api/update_vendor',
                data,
                this.httpOptionsFormdata
            )
            .pipe(
    ...
    getPage(dataTablesParameters: any): Observable<DataTablesResponse> {
        return this._httpClient
            .post(
                environment.API_URL + 'api/vendor_page',
                dataTablesParameters,
                this.httpOptionsFormdata
            )
            .pipe(
    ...
    getLogisticServices(): Observable<any[]> {
        return this._httpClient
            .get<any[]>(environment.API_URL + 'api/get_logistic_services')
            .pipe(
                tap((meterial) => {
                    this._materials.next(meterial);
                })
    ...
    getScrapServices(): Observable<any[]> {
        return this._httpClient
            .get<any[]>(environment.API_URL + 'api/get_scrap_services')
            .pipe(
                tap((meterial) => {
                    this._materials.next(meterial);
                })
    ...
    getPurchaseServices(): Observable<any[]> {
        return this._httpClient
            .get<any[]>(environment.API_URL + 'api/get_purchase_services')
            .pipe(
                tap((meterial) => {
                    this._materials.next(meterial);
                })
