...
export class Service {
    ...
    create(data: any): Observable<any> {
        return this._httpClient
            .post(environment.API_URL + '/api/blog', data, {
                headers: this.httpOptionsFormdata.headers,
            })
            .pipe(
                switchMap((response: any) => {
    ...
    getCategory(): Observable<any> {
      return this._httpClient.get<any>(environment.API_URL + '/api/get_category_blog').pipe(
        tap((data) => {
    ...
    getById(id: any): Observable<any[]> {
        return this._httpClient
            .get<any[]>(environment.API_URL + '/api/blog/' + id)
            .pipe(
                tap((meterial) => {
                    this._materials.next(meterial);
                })
    ...
    getPage(dataTablesParameters: any): Observable<DataTablesResponse> {
        return this._httpClient
            .post(
                environment.API_URL + '/api/blog_page',
