...
import {
    ...
    UserPagination, UserProduct, StoreType, AssetSize, Supplier, Division, DataUser
} from './page.types';
...
export class UserService {
    ...
    private _product: BehaviorSubject<UserProduct | null> = new BehaviorSubject(null);
    private _products: BehaviorSubject<UserProduct[] | null> = new BehaviorSubject(null);
    private _product_osm: BehaviorSubject<UserProduct | null> = new BehaviorSubject(null);
    private _products_osm: BehaviorSubject<UserProduct[] | null> = new BehaviorSubject(null);
     ...
     * Getter for product
     */
    get product$(): Observable<UserProduct> {
     ...
     * Getter for products
     */
    get products$(): Observable<UserProduct[]> {
     ...
     * Getter for product
     */
    get product_osm$(): Observable<UserProduct> {
...
*/
    ...
    getProducts(page: number = 0,
        ...
        Observable<{ meta: UserPagination; data: UserProduct[] }> {
        ...
        return this._httpClient.get<{ meta: UserPagination; data: UserProduct[] }>(environment.API_URL + 'api/briefs', {
    ...
    getProductsND(page: number = 0,
        ...
        return this._httpClient.get<{ meta: UserPagination; data: UserProduct[] }>(environment.API_URL + 'api/brief-osms', {
            params: searchParams, headers: new HttpHeaders({ Authorization: `Bearer ${token}` })
        }).pipe(
            tap((response) => {
                this._pagination.next({
    ...
    * Get product by id
    */
    getProductOSMById(id: string): Observable<PermissionProductDetailOSM> {
        // this.getProducts();
        return this._httpClient.get<any>(environment.API_URL + 'api/brief-osms/' + id, {
            headers: new HttpHeaders({ Authorization: `Bearer ${token}` }),
            params: {
                'populate[0]': 'brief_osm_stores.brief_osm_store_files.file',
                'populate[1]': 'artwork_supplier_id',
                'populate[2]': 'production_supplier_id',
                'populate[3]': 'brief_files',
                'populate[4]': 'brief_osm_stores.store',
                'populate[5]': 'brief_osm_stores.brief_osm_store_reports.files',
                'populate[6]': 'brief_osm_stores.two_approver',
            }
        }
        ).pipe(
            take(1),
     ...
     * Create product
     */
    createProduct(): Observable<UserProduct> {
        return this.products$.pipe(
            take(1),
            switchMap(products => this._httpClient.post<UserProduct>('api/marketing/brief-plan/product', {}).pipe(
                map((newProduct) => {
     ...
     * @param product
     */
    updateProduct(id: string, product: UserProduct): Observable<UserProduct> {
        return this.products$.pipe(
            take(1),
            switchMap(products => this._httpClient.patch<UserProduct>('api/marketing/brief-plan/product', {
                id,
                product
            }).pipe(
                map((updatedProduct) => {
...
*/
    ...
    getUser(): Observable<any[]> {
        return this._httpClient.get<any[]>(environment.API_URL + 'api/get_user').pipe(
            tap((user) => {
                this._materials.next(user);
            })
        );
    }
    getUserprofile(): Observable<any[]> {
        return this._httpClient.get<any[]>(environment.API_URL + 'api/user_profile', this.httpOptionsFormdata)
            .pipe(
                tap((user) => {
    ...
    // getUserprofile(): Observable<any> {
    //     return this._httpClient
    //       .get<any>(environment.API_URL +'api/user_profile' , this.httpOptionsFormdata)
    //       .pipe(catchError(this.handlerError));
    //   }


    createUser(data: FormData): Observable<DataUser> {
        return this._httpClient.post<DataUser>(environment.API_URL + 'api/create_admin', data, { headers: this.httpOptionsFormdata.headers });
    }
    createUser1(data: FormData): Observable<DataUser> {
        return this._httpClient.post<DataUser>(environment.API_URL + 'api/user', data, { headers: this.httpOptionsFormdata.headers });
    }

    updateUser(data: FormData): Observable<DataUser> {
        return this._httpClient.post<DataUser>(environment.API_URL + 'api/update_user', data, { headers: this.httpOptionsFormdata.headers });
    }
    updateUserprofile(data: FormData): Observable<DataUser> {
        return this._httpClient.post<DataUser>(environment.API_URL + 'api/update_profile_user', data, { headers: this.httpOptionsFormdata.headers });
    }
    getUserbyId(userId: any): Observable<any[]> {
        return this._httpClient.get<any[]>(environment.API_URL + 'api/user/' + userId).pipe(
            tap((meterial) => {
                this._materials.next(meterial);
            })
        );
    ...
    changepassword(password: any, userId): Observable<any> {
        return this._httpClient.put(environment.API_URL + 'api/reset_password_user/' + userId, password, this.httpOptionsFormdata).pipe(
            switchMap((response: any) => {
                // Return a new observable with the response
                return of(response);
            })
    ...
    getuserpage(dataTablesParameters: any): Observable<DataTablesResponse> {
        return this._httpClient.post(environment.API_URL + 'api/user_job_page', dataTablesParameters, this.httpOptionsFormdata).pipe(
            switchMap((response: any) => {
