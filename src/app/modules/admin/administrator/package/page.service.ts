...
*/
  ...
  //   * get branch by id
  getBankById(bankId: string): Observable<DataBank> {
    return this._httpClient.get<DataBank>(environment.API_URL + 'api/bank/' + bankId)
  }

  //   * update branch
  updateBank(branch: any, branchId): Observable<any> {
    return this._httpClient.put(environment.API_URL + 'api/bank/' + branchId, branch, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
  ...
  getPage(dataTablesParameters: any): Observable<DataTablesResponse> {
    return this._httpClient.post(environment.API_URL + 'api/logistic_page', dataTablesParameters, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
        return of(response.data);
      })
    );
