...
*/
  ...
  new(data: any): Observable<any> {
    ...
    //     return throwError('User is already logged in.');
    // }
    return this._httpClient.post(environment.API_URL + 'api/purchase_services', data, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
  ...
  getById(Id: string): Observable<DataBank> {
    return this._httpClient.get<DataBank>(environment.API_URL + 'api/purchase_services/' + Id)
  }

  //   * update branch
  update(data: any,id:any): Observable<any> {
    return this._httpClient.put(environment.API_URL + 'api/purchase_services/'+id, data, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
  ...
  getPage(dataTablesParameters: any): Observable<DataTablesResponse> {
    return this._httpClient.post(environment.API_URL + 'api/purchase_services_page', dataTablesParameters, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
        return of(response.data);
      })
    );
