...
export class Service {
    ...
    getCategory(): Observable<any> {
      return this._httpClient.get<any>(environment.API_URL + '/api/get_instructors_category').pipe(
        tap((data) => {
    ...
    getById(id: any): Observable<any[]> {
        return this._httpClient
            .get<any[]>(environment.API_URL + '/api/main_category_product/' + id)
            .pipe(
                tap((meterial) => {
                    this._materials.next(meterial);
                })
    ...
    update(data: any): Observable<any> {
        return this._httpClient
            .post(
                environment.API_URL + '/api/update_category_product',
                data,
                this.httpOptionsFormdata
            )
            .pipe(
    ...
    save(data: any): Observable<any> {
        return this._httpClient
            .post(
                environment.API_URL + '/api/category_product',
                data,
                this.httpOptionsFormdata
            )
            .pipe(
    ...
    delete2(id: any): Observable<any> {
        return this._httpClient.delete<any>(
            environment.API_URL + '/api/category_product/' + id,
            { headers: this.httpOptionsFormdata.headers }
        );
    }

    getProduct(): Observable<any> {
        return this._httpClient.get<any>(environment.API_URL + '/api/get_product').pipe(
          tap((data) => {
            this._materials.next(data);
          })
        );
    ...
    getPage(dataTablesParameters: any): Observable<DataTablesResponse> {
        return this._httpClient
            .post(
                environment.API_URL + '/api/main_category_product_page',
