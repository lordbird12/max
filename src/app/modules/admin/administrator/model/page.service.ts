...
export class Service {
    ...
    create(data: any): Observable<any> {
        return this._httpClient
            .post(environment.API_URL + '/api/course', data, {
    ...
    getList(): Observable<any> {
        return this._httpClient
            .get<any>(environment.API_URL + 'api/get_course')
            .pipe(
                tap((meterial) => {
    ...
    getCategory(): Observable<any> {
        return this._httpClient
            .get<any>(environment.API_URL + '/api/get_model_category')
            .pipe(
                tap((data) => {
    ...
    getInstructor(): Observable<any> {
        return this._httpClient
            .get<any>(environment.API_URL + '/api/get_instructors')
            .pipe(
                tap((data) => {
                    this._materials.next(data);
                })
    ...
    getById(id: any): Observable<any[]> {
        return this._httpClient
            .get<any[]>(environment.API_URL + '/api/course/' + id)
            .pipe(
                tap((meterial) => {
                    this._materials.next(meterial);
                })
    ...
    update(data: any): Observable<any> {
        return this._httpClient
            .post(
                environment.API_URL + '/api/update_course',
                data,
                this.httpOptionsFormdata
            )
            .pipe(
    ...
    update2(data: any): Observable<any> {
        return this._httpClient
            .post(
                environment.API_URL + '/api/curriculum',
                data,
                this.httpOptionsFormdata
            )
            .pipe(
    ...
    update3(data: any): Observable<any> {
        return this._httpClient
            .post(
                environment.API_URL + '/api/course_review',
                data,
                this.httpOptionsFormdata
            )
            .pipe(
    ...
    update4(data: any): Observable<any> {
        return this._httpClient
            .post(
                environment.API_URL + '/api/upload_course_file',
                data,
                this.httpOptionsFormdata
            )
            .pipe(
    ...
    delete(id: any): Observable<any> {
        return this._httpClient.delete<any>(
            environment.API_URL + '/api/course/' + id,
            { headers: this.httpOptionsFormdata.headers }
        );
    }
    ...
    deleteFile(id: any): Observable<any> {
        return this._httpClient.get<any>(
            environment.API_URL + '/api/delete_course_file/' + id,
            { headers: this.httpOptionsFormdata.headers }
        );
    }
    ...
    getPage(dataTablesParameters: any): Observable<DataTablesResponse> {
        return this._httpClient
            .post(
                environment.API_URL + '/api/model_page',
    ...
    upload(file: File): Observable<HttpEvent<any>> {
        ...
        const req = new HttpRequest(
            'POST',
            `${environment.API_URL}/api/upload_file`,
            formData,
            {
                reportProgress: true,
                responseType: 'json',
    ...
    getFiles(): Observable<any> {
        return this._httpClient.get(`${environment.API_URL}/files`);
    }
}
