...
export class Service {
    ...
    create(data: any): Observable<any> {
        return this._httpClient
            .post(environment.API_URL + '/api/galleries_category', data, {
    ...
    getById(id: any): Observable<any[]> {
        return this._httpClient
            .get<any[]>(environment.API_URL + '/api/galleries_category/' + id)
            .pipe(
                tap((meterial) => {
                    this._materials.next(meterial);
                })
    ...
    update(data: any): Observable<any> {
        return this._httpClient
            .post(
                environment.API_URL + '/api/update_galleries_category',
                data,
                this.httpOptionsFormdata
            )
            .pipe(
    ...
    delete(id: any): Observable<any> {
        return this._httpClient.delete<any>(
            environment.API_URL + '/api/galleries_category/' + id,
            { headers: this.httpOptionsFormdata.headers }
        );
    }
    ...
    getPage(dataTablesParameters: any): Observable<DataTablesResponse> {
        return this._httpClient
            .post(
                environment.API_URL + '/api/galleries_category_page',
